...
class Game extends React.Component {
  ...
  lambGen = (x, y, i, coord) => {
    ...
    img.style.left = (window.innerWidth > 1700 ? y - 32 + "px" : y - 17 + "px")
  ...
  tigerGen = (x, y, i, coord) => {
    ...
    img2.style.left = (window.innerWidth > 1700 ? y - 32 + "px" : y - 17 + "px")
    ...
    img2.addEventListener("click", e => {
      ...
      if (this.state.tigerMove == true && this.state.whoseTurn=="tiger" && this.state.gameEnded==false) {
        ...
        swal(
          <div>
              <h1 className={styles.swalText}>Move On</h1>
              <img src="/images/tigergame.png" alt="tiger" height="60px"/>
              <p className={`text-white h3 ${styles.swalText}`}>
               Game is over now
              </p>
          </div>
      ...
      <div className={styles.forinvalid}>
        {this.state.whoseTurn == "tiger" ? (
          ...
          <img
            ...
            alt="tiger"
          />
           <p className={`h3 text-white col-2 ${styles.text90}`}>{this.props.player2}</p>
          </>
        ) : (
          <>
          <img
